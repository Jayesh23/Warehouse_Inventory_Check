...
pid = PIDController(proportional = 0.15, derivative_time = 10, integral_time=0)
...
def following (vstate):
    ...
    maxPitch = -2 # Maximum pitch for target at 0 bearing.
    ...
    while vstate =="following":
		...
		print("bearing :", bearing, "offset :", offset, "yaw :", yaw, "roll :", roll, "pitch :", pitch)
